export const data = [
  ...
  },
  {
    ...
    comments: [ 'Умею читать java-код', 'могу подготовить схему данных БД']
  },
  {
    name: '-',
    level: 10,
    ...
    skills: [
      ...
      'ПСИ',
      'Тираж',
      'Написание клиентских инструкций',
      'UI/UX исследования'
    ],
    specs: [
      'Release Team',
    ...
    comments: [ 'Глубокие знания Java', 'Проактивность', 'Большой опыт в проведении ПСИ', 'Развытие софт скиллы']
  },
  {
    name: '-',
    level: 9,
